...
//Agregar
            public function addUser($nombre, $apellido, $alias, $password, $foto_ruta, $foto_nombre, $fecha_modificado, $status){
	...
	$this->usu_fecha_creado = $fecha_modificado;
	...
	public function UpdateUserSet($nombre, $apellido, $alias, $password, $foto_ruta, $foto_nombre, $fecha_modificado, $status)//v1 pasar variables al modelo para que las cargue en sus atributos
	{//deberíamos poner métodos donde se purifique los post y get por seguridad.
		$this->usu_nombre = $nombre;
		$this->usu_apellido = $apellido;
		$this->usu_alias = $alias;
		$this->usu_pass = $password;
		$this->usu_foto_ruta = $foto_ruta;
		$this->usu_foto_nombre = $foto_nombre;
		$this->usu_fecha_modificado = $fecha_modificado;
		$this->usu_status = $status;
		parent::updateUsersM();
                       $this->redirect();
