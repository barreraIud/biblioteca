...
<div class="modal animated zoomIn faster" id="modalAgregar" tabindex="-1" role="dialog" aria-labelledby="modalAgregarTitle"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
    	<form class="needs-validation" novalidate action="customers" method="POST" name="formAdd">
...
<div class="modal animated zoomIn faster" id="modalActualizar" tabindex="-1" role="dialog" aria-labelledby="modalActualizarTitle"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
    	<form class="needs-validation" novalidate action="customers" method="POST" name="formUpd">
	      <div class="modal-header text-center">
...
<!--			      <div class="md-form mb-5">
			        	<label data-error="wrong" data-success="right" for="updtTelefono">Telefono</label>
...
<script>
	function actualizar(id, nombre, apellido, correo, telefono, status){
		//alert("El id es: "+id)
	...
	function eliminar(id){
		var datos = {
			...
			$.ajax({
				type: "POST",
				url: "/projects/%5b1%5d%20Interacpedia/15474_vanilla/v1/customers",
				data: datos,
				success: function(respuesta){//va al archivo con las post y en respuesta nos manda el retorno que tenemos en el 'receptor'.
					console.log(" "+respuesta)
					if(respuesta==1){
