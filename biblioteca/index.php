...
<form class="row g-3 needs-validation" novalidate method="POST" action="controller/agregarController.php">
 ...
 <div class="col-md-4">
    <label for="validationCustom01" class="form-label">Código de libro</label>
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit" name="Buscar" value="Buscar">Iniciar búsqueda</button>
  </div>
</form>
