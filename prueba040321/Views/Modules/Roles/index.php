			    ...
			    <tr id="row<?= $rol_data->rol_id; ?>">			      
			      ...
			      <td >
			      	<div class="row col-12" > <!-- ver otra forma de arreglar el espaciado de los botones con este col-12 y abajo mr-5 wtf pendiente.. -->
				      		...
				      		<div  class="col-lg-6 "> 
					      		<a onclick="actualizar( '<?= $rol_data->rol_id; ?>' , '<?= $rol_data->rol_nombre; ?>','<?= $rol_data->rol_fecha_modificado; ?>','<?= $rol_data->rol_status; ?>')"  
					      		  data-toggle="modal" 
								  type="button"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
    	<form class="needs-validation" novalidate action="roles" method="POST" name="formUpd">
	      <div class="modal-header text-center">
	        <h5 class="modal-title w-100 font-weight-bold dark-grey-text my-3" id="exampleModalLongTitle">Actualizar Roles</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
...
document.querySelector("#title").innerHTML += '<a href=""> Rol</a>'
